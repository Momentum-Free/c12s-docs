...
To add the C12s bot to your server, you have two methods, via the [C12s webapp](https://app.c12s.ai?r=docs) hover over the connect button and select "Discord", it will open a new prompt where you can click the "Invite Bot" and you will be directed to the Discord invite page or press [here](https://discord.com/oauth2/authorize?client_id=1287755859690262588&permissions=8&response_type=code&redirect_uri=https://api.c12s.ai/api/auth/callback/discord&scope=bot) to directly open the Discord invite page.
...
To link the bot to your C12s Organization, you need to go to the [C12s webapp](https://app.c12s.ai?r=docs), head over to the "Settings" page, hover your mouse over the connect button and select "Discord".

![Use the /verify command](src/assets/screenshots/platforms/discord/copy-code.gif)

After selecting Discord you should see a verification code such as:
...
After pasting or typing the code, the bot should appear as connected in the C12s webapp.
