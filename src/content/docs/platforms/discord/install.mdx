...
To add the C12s bot to your server, you have two methods, via the [C12s webapp](https://app.c12s.ai?r=docs) hover over the connect button and select "Discord", it will open a new prompt where you can click the "Invite Bot" and you will be directed to the Discord invite page or press [here](https://discord.com/oauth2/authorize?client_id=1287755859690262588&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Fapp.c12s.ai%2Fconnect&scope=bot) to directly open the Discord invite page.
