...
- The graph's footnotes are now also live (showing trends) for the first (C12s Performance) and last graph (Community Activity).
  - Note: we still need to fix the middle one (Community Engagement).
